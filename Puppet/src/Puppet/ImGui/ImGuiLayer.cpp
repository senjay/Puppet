...
#include "imgui.h"
#include "Puppet/Platform/OpenGL/ImGuiOpenGLRenderer.h"
...
namespace Puppet {
	...
	void Puppet::ImGuiLayer::OnAttach()
	{
		ImGui::CreateContext();
		...
		// TEMPORARY: should eventually use Puppet key codes
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<WindowResizeEvent>(PP_BIND_EVENT_FN(ImGuiLayer::OnWindowResizeEvent));
	}
