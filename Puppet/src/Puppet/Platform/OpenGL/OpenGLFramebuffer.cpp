...
namespace Puppet
{
	...
	void OpenGLFramebuffer::Invalidate()
	{
		...
		PP_ASSERT(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Frame buffer is in complete!");
	...
	{
		//PP_CORE_ASSERT(attachmentIndex < m_ColorAttachments.size());
